        ...
        <div className='min-h-screen p-4 bg-zinc-50 dark:bg-neutral-900/80 '>
            ...
            <div className="mx-auto grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-6">
                ...
                <div className="col-span-12 lg:col-span-8 xl:col-span-9 space-y-6">
                    ...
                    {/* Contribution Graph */}
                    <div className="bg-white dark:bg-neutral-800/50 border border-gray-200 dark:border-neutral-700 rounded-lg p-4 shadow-sm hover:shadow transition-shadow duration-200">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Contribution Activity</h3>
                        ...
                        <div className="h-64 w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart
                                    data={Object.entries(contributionGraph).map(([date, count]) => ({
                                ...
                                >
                                            ...
                                            if (active && payload && payload.length) {
                                                return (
                                                    <div className="bg-white dark:bg-neutral-800 p-2 border border-slate-200 dark:border-neutral-700 rounded-lg shadow-lg">
                                                        ...
                                                        <p className="text-sm text-emerald-600 dark:text-violet-400">
                                    ...
                                    <Area
                                        ...
                                        fillOpacity={1}
                                        fill="url(#colorCountLight)"
                                        classNameDark="fill-violet-900/20"
                                        strokeWidth={2}
                                        activeDot={{
                                            r: 5,
                                            fill: '#10b981',
                                            stroke: '#fff',
                                            strokeWidth: 2,
                                            className: 'dark:fill-violet-500 dark:stroke-violet-900/50',
